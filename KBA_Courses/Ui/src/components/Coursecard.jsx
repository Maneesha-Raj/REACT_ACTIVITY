...
// const Coursecard = ({courseTitle ,description}) => {
//   return (
//     <>
//         <div className=' bg-purple-100  rounded-md shadow-2xl flex flex-col items-center justify-center mx-5 my-5 py-10'>
//             <h2 className=' font-bold text-lg text-purple-900 '>{course.courseTitle}</h2>
//             <img src={pics} alt="course thumbnail" className='w-80 h-40 ' />
    ...
    return (
      <>
          <div className=' bg-purple-100  rounded-md shadow-2xl flex flex-col items-center justify-center mx-5 my-5 py-10'>
              ...
              <button onClick={toggleText} className='font-bold text-lg text-purple-900'>{showFullDescription?'less':'more'}</button>
              <a href="#" className="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600 self-start mx-5">Learn More</a>
          </div>
